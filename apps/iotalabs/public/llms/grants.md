...
> Apply for a grant from iotalabs to fund your Web3 or DLT project and build on IOTA Mainnet. Grants support open-source innovation, research, and real-world adoption across three funding tiers.

**Canonical URL:** https://iotalabs.io/grants
**Last updated:** 2026-02-27

## Overview

The IOTA Grants program, administered by iotalabs, provides financial support for projects building on the IOTA ecosystem. Grants cover dApps, tooling, education, events, and real-world DLT applications. Projects must build on or connect to IOTA Mainnet.
...
1. **Application Submission** — Check that your project fits the guidelines and fill out the application form. Provide as much detail as possible.
...
3. **Evaluation and Interview** — The interview addresses remaining questions. The application is then assessed by committee members.

...
export const I_CIRCULAR3_BUTTONS = [
    {
        text: 'Learn more',
        link: 'https://www.ucd.ie/lams/vacancies/icircular3doctoralnetwork/',
        variant: ButtonVariant.Primary,
    },
    {
        text: 'Blog Post',
        link: 'https://www.icircular3.eu/stakeholders.html?ref=blog.iota.org',

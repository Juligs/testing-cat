...
export const INTRO_METADATA_TITLE =
...
export const INTRO_URL = `${BASE_URL}/learn/intro`;
export const INTRO_IMAGE = '/metadata/meta_image_intro.png';
...
export const FOCUS_AREAS_IMAGE = '/metadata/meta_image_focus_areas.png';
export const FOCUS_AREAS_URL = `${BASE_URL}/learn/focus-areas`;
...
export const SHOWCASES_IMAGE = '/metadata/meta_image_showcases.png';
export const SHOWCASES_URL = `${BASE_URL}/learn/showcases`;
...
export const EBSI_IMAGE = '/metadata/meta_image_showcases_ebsi.png';
export const EBSI_URL = `${BASE_URL}/learn/showcases/ebsi`;
...
export const IPRM_IMAGE = '/metadata/meta_image_showcases_ipmr.png';
export const IPRM_URL = `${BASE_URL}/learn/showcases/iprm`;
...
export const KYC_IMAGE = '/metadata/meta_image_showcases_kyc.png';
export const KYC_URL = `${BASE_URL}/learn/showcases/kyc`;
...
export const MULTIKNIP_IMAGE = '/metadata/meta_image_showcases_multiknip.png';
export const MULTIKNIP_URL = `${BASE_URL}/learn/showcases/multiknip`;

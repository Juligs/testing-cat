<h1 className="text-headline-md text-network-neutral-10">Privacy Policy</h1>

This privacy policy (“Policy”) describes how your personal data is processed when you use IOTA’s website (the “Website”) and provides information about your rights. The Website is provided by Verein Tangle Ecosystem (Tangle Ecosystem Association) (“we”, “us” or “our”), a company registered in Switzerland. Verein Tangle Ecosystem is committed to the highest integrity in dealings with users, investors, employees, collaborators, and other business partners, in accordance with applicable data protection laws, particularly the European General Data Protection Regulation (GDPR).

To properly operate and provide the Website, we must process your data. Verein Tangle Ecosystem is the controller of the personal data obtained via the Website, meaning it is the organization legally responsible for deciding how and for what purposes it is used.
...
**Verein Tangle Ecosystem (Tangle Ecosystem Association)**

Baarerstrasse 95 <br/>
CH - 6300 Zug <br/>
Switzerland <br/>
legal@tangle-association.ch <br/>
...
For more information, please refer to our [Cookie Policy](https://docs.google.com/document/d/1m6Up51v31NRSunCgEzdYLqQUOiySkQrf/edit#heading=h.gjdgxs).
...
For more information, please refer to [Google Analytics' data protection and privacy statement](https://support.google.com/analytics/answer/12017362?hl=en#:~:text=Google%20Analytics%204%20does%20not%20log%20or%20store%20individual%20IP,and%20ID%2Dbased%20counterparts).

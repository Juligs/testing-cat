    ...
    return (
        <section className="w-full" id={id} data-navbar-color-scheme={navbarColorScheme}>
            <div className="container py-14 xs:py-20 lg:py-30 flex flex-col gap-14 xs:gap-20 sm:gap-30">
                <TwoColumnsImageTemplate image="/learn/tokenomics/balance_system.png">
                    <div className="sm:pr-[92px] lg:pr-[102px] text-center">
                        <VerticalTitle {...BALANCED_SYSTEM_VERTICAL_TITLE}>
                            <Actions>
                                <Link
                ...
                <div className="grid grid-cols-1 xs:grid-cols-3 gap-6">
                    {BALANCED_SYSTEM_ICON_CONTENT.map((data, index) => (

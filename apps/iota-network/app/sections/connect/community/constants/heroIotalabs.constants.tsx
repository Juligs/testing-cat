...
export const HERO_IOTALABS_CONTENT = {
    ...
    body: 'iotalabs drives ecosystem growth through partnerships, tech integration, grants, and strategic investments. It supports builders and token holders by promoting DeFi applications and ROI opportunities, bridging Web2 and Web3.',
    inverted: true,
};

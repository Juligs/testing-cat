...
const EVENTS_OVERVIEW =
    'Connect with the creators of the network, exchange ideas, and explore new opportunities.';

export function EventsOverview({ id, navbarColorScheme }: BaseSectionProps) {
    return (
        <section

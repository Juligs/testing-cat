...
const IDENTITY_OVERVIEW =
    'An open-source, modular toolkit for recording and verifying data integrity – built for compliance, traceability, and auditability to anchor trust in your workflows.';

export function NotarizationOverview({ id, navbarColorScheme }: BaseSectionProps) {
    return (
        <section

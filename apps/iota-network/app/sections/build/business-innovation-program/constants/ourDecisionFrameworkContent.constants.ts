...
export const OUR_DECISION_VERTICAL_TITLE = {
    title: 'Our Decision Framework',
    subtitle: "Criteria for assessing your project's potential",
    body: "We support projects that aligns with the program's goals and brings real-world utility to the IOTA Mainnet. To qualify, proposals must meet the following criteria:",
    size: TitleTextSize.Small,
};

export const OUR_DECISION_IMAGE_CARD_CONTENT = [
    {

...
import { PROJECT_FUNDING_GRANTS_VERTICAL_TITLE } from './constants';
import Link from 'next/link';
import { TwoColumnsImageTemplate } from '@repo/shared/components';
import { ArrowTopRight } from '@repo/icons';
import { FetchGrantsSliderData, FetchGrantsStatsData } from '@repo/shared/sections';

export function ProjectFundingGrants({ id, navbarColorScheme }: BaseSectionProps) {
    return (
            ...
            <div className="container py-14 xs:py-20 lg:py-30 flex flex-col gap-14 xs:gap-20 sm:gap-30">
                <TwoColumnsImageTemplate image="/build/grants/project_funding.png">
                    <div className="sm:pr-[92px] lg:pr-[102px] text-center">
                        <VerticalTitle {...PROJECT_FUNDING_GRANTS_VERTICAL_TITLE}>
                            <Actions>
                                <Link
                                    href={PROJECT_FUNDING_GRANTS_VERTICAL_TITLE.link}
                                    target="_blank"

...
export const CARD_BORDER_DEFAULT = 'border 1px solid text-transparency-black-16';
export const CARD_BORDER_INVERTED = 'border 1px solid text-transparency-white-16';
export const CARD_BORDER_RADIUS = 'rounded-3xl';

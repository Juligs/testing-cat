...
import { DEMIA_SECTION_1_LOGOS_CAROUSEL } from './constants';

const TEXT = 'Built with our Partner';

export function DemiaSection1({ id, theme }: BaseSectionProps) {
    return (
        <section className="w-full" id={id} data-theme={theme}>
            <div className="container w-full flex flex-col gap-6 xs:gap-12 py-6 xs:py-12">
                ...
                <InfiniteCarousel logos={DEMIA_SECTION_1_LOGOS_CAROUSEL} />
            </div>
        </section>
    );
}

...
import { KYC_PARTNERS_LOGOS_CAROUSEL } from './constants';

const TEXT = 'Built with our Partners';

export function KYCPartners({ id, navbarColorScheme }: BaseSectionProps) {
    return (
        <section className="w-full" id={id} data-navbar-color-scheme={navbarColorScheme}>
            <div className="container w-full flex flex-col gap-6 xs:gap-12 py-6 xs:py-12">
                ...
                <InfiniteCarousel logos={KYC_PARTNERS_LOGOS_CAROUSEL} />
            </div>
        </section>
    );
}

...
export function DigitalIdentity({ id, theme }: BaseSectionProps) {
    return (
        <section className="w-full bg-labs-neutral-100" id={id} data-theme={theme}>
            <div className="container py-14 xs:py-20 lg:py-30">
                <TwoColumnsImageTemplate image="/shared/focus-areas-sections/digital_identity.png">
                    <div className="sm:pr-[92px] lg:pr-[102px] text-center">
                        <VerticalTitle {...DIGITAL_IDENTITY_VERTICAL_TITLE_CONTENT}>
                            <Actions>
                                <a href="/learn/showcases/kyc" aria-label="See showcase">
                                    <Button

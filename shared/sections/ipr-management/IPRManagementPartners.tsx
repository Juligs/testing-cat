...
import { IPR_MANAGEMENT_PARTNERS_LOGOS_CAROUSEL } from './constants';

const TEXT = 'Built with our Partner';

export function IPRManagementPartners({ id, theme }: BaseSectionProps) {
    return (
        <section className="w-full" id={id} data-theme={theme}>
            <div className="container w-full flex flex-col gap-6 xs:gap-12 py-6 xs:py-12">
                ...
                <InfiniteCarousel logos={IPR_MANAGEMENT_PARTNERS_LOGOS_CAROUSEL} />
            </div>
        </section>
    );
}
